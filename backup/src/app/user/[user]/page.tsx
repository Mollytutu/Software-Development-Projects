...
import pic from '../../../assets/images/profile1.png'
...
const[date, setDate] = useState<DateTime>({
  ...
  return (
    <>
      <Header /> 
      <div className=" text-gray-600 container px-4 font-sans bg-blue-300 w-full">
        <h1 className="py-8 text-3xl font-bold mt-8 text-center text-gray-600">Hi, I'm Tony Porterifeld</h1>
        ...
        <h2 className='font-bold text-gray-600 my-6 ml-4'>What Tony Offers</h2>
